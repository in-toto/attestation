...
//! Generated file from `in_toto_attestation/predicates/vsa/v0/vsa.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_2;

// @@protoc_insertion_point(message:in_toto_attestation.predicates.vsa.v0.VerificationSummary)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct VerificationSummary {
    // message fields
    // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.verifier)
    pub verifier: ::protobuf::MessageField<verification_summary::Verifier>,
    // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.time_verified)
    pub time_verified: ::protobuf::MessageField<::protobuf::well_known_types::timestamp::Timestamp>,
    // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.resource_uri)
    pub resource_uri: ::std::string::String,
    // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.policy)
    pub policy: ::protobuf::MessageField<verification_summary::Policy>,
    // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.input_attestations)
    pub input_attestations: ::std::vec::Vec<verification_summary::InputAttestation>,
    // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.verification_result)
    pub verification_result: ::std::string::String,
    // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.policy_level)
    pub policy_level: ::std::string::String,
    // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.dependency_levels)
    pub dependency_levels: ::std::collections::HashMap<::std::string::String, u64>,
    // special fields
    // @@protoc_insertion_point(special_field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.special_fields)
...
impl VerificationSummary {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "policy_level",
            |m: &VerificationSummary| { &m.policy_level },
            |m: &mut VerificationSummary| { &mut m.policy_level },
        ));
...
impl ::protobuf::Message for VerificationSummary {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                58 => {
                    self.policy_level = is.read_string()?;
                },
                66 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.policy_level.is_empty() {
            my_size += ::protobuf::rt::string_size(7, &self.policy_level);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.policy_level.is_empty() {
            os.write_string(7, &self.policy_level)?;
        }
        for (k, v) in &self.dependency_levels {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::string_size(1, &k);
...
pub mod verification_summary {
    // @@protoc_insertion_point(message:in_toto_attestation.predicates.vsa.v0.VerificationSummary.Verifier)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Verifier {
        // message fields
        // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.Verifier.id)
        pub id: ::std::string::String,
        // special fields
        // @@protoc_insertion_point(special_field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.Verifier.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    // @@protoc_insertion_point(message:in_toto_attestation.predicates.vsa.v0.VerificationSummary.Policy)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct Policy {
        // message fields
        // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.Policy.uri)
        pub uri: ::std::string::String,
        // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.Policy.digest)
        pub digest: ::std::collections::HashMap<::std::string::String, ::std::string::String>,
        // special fields
        // @@protoc_insertion_point(special_field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.Policy.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
    ...
    // @@protoc_insertion_point(message:in_toto_attestation.predicates.vsa.v0.VerificationSummary.InputAttestation)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct InputAttestation {
        // message fields
        // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.InputAttestation.uri)
        pub uri: ::std::string::String,
        // @@protoc_insertion_point(field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.InputAttestation.digest)
        pub digest: ::std::collections::HashMap<::std::string::String, ::std::string::String>,
        // special fields
        // @@protoc_insertion_point(special_field:in_toto_attestation.predicates.vsa.v0.VerificationSummary.InputAttestation.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n/in_toto_attestation/predicates/vsa/v0/vsa.proto\x12%in_toto_attestati\
    on.predicates.vsa.v0\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfd\x08\n\
    \x13VerificationSummary\x12_\n\x08verifier\x18\x01\x20\x01(\x0b2C.in_tot\
    o_attestation.predicates.vsa.v0.VerificationSummary.VerifierR\x08verifie\
    r\x12@\n\rtime_verified\x18\x02\x20\x01(\x0b2\x1a.google.protobuf.Timest\
    ampR\rtime_verified\x12\"\n\x0cresource_uri\x18\x03\x20\x01(\tR\x0cresou\
    rce_uri\x12Y\n\x06policy\x18\x04\x20\x01(\x0b2A.in_toto_attestation.pred\
    icates.vsa.v0.VerificationSummary.PolicyR\x06policy\x12{\n\x12input_atte\
    stations\x18\x05\x20\x03(\x0b2K.in_toto_attestation.predicates.vsa.v0.Ve\
    rificationSummary.InputAttestationR\x12input_attestations\x120\n\x13veri\
    fication_result\x18\x06\x20\x01(\tR\x13verification_result\x12\"\n\x0cpo\
    licy_level\x18\x07\x20\x01(\tR\x0cpolicy_level\x12~\n\x11dependency_leve\
    ls\x18\x08\x20\x03(\x0b2P.in_toto_attestation.predicates.vsa.v0.Verifica\
    tionSummary.DependencyLevelsEntryR\x11dependency_levels\x1a\x1a\n\x08Ver\
    ifier\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\x1a\xbc\x01\n\x06Policy\
    \x12\x10\n\x03uri\x18\x01\x20\x01(\tR\x03uri\x12e\n\x06digest\x18\x02\
    \x20\x03(\x0b2M.in_toto_attestation.predicates.vsa.v0.VerificationSummar\
    y.Policy.DigestEntryR\x06digest\x1a9\n\x0bDigestEntry\x12\x10\n\x03key\
    \x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05va\
    lue:\x028\x01\x1a\xd0\x01\n\x10InputAttestation\x12\x10\n\x03uri\x18\x01\
    \x20\x01(\tR\x03uri\x12o\n\x06digest\x18\x02\x20\x03(\x0b2W.in_toto_atte\
    station.predicates.vsa.v0.VerificationSummary.InputAttestation.DigestEnt\
    ryR\x06digest\x1a9\n\x0bDigestEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\
    \x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01\x1aC\n\
    \x15DependencyLevelsEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\
    \x12\x14\n\x05value\x18\x02\x20\x01(\x04R\x05value:\x028\x01Be\n.io.gith\
    ub.intoto.attestation.predicates.vsa.v0Z3github.com/in-toto/attestation/\
    go/predicates/vsa/v0b\x06proto3\
";
