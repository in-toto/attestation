...
func file_in_toto_attestation_predicates_scai_v0_scai_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_in_toto_attestation_predicates_scai_v0_scai_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_in_toto_attestation_predicates_scai_v0_scai_proto_msgTypes[1].Exporter = func(v any, i int) any {
