...
func file_in_toto_attestation_predicates_vsa_v0_vsa_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_in_toto_attestation_predicates_vsa_v0_vsa_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_in_toto_attestation_predicates_vsa_v0_vsa_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_in_toto_attestation_predicates_vsa_v0_vsa_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_in_toto_attestation_predicates_vsa_v0_vsa_proto_msgTypes[3].Exporter = func(v any, i int) any {
