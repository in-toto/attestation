...
const file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDesc = "" +
	"\n" +
	"?in_toto_attestation/predicates/test_result/v0/test_result.proto\x12-in_toto_attestation.predicates.test_result.v0\x1a0in_toto_attestation/v1/resource_descriptor.proto\"\xf1\x01\n" +
	"\n" +
	"TestResult\x12\x16\n" +
	"\x06result\x18\x01 \x01(\tR\x06result\x12P\n" +
	"\rconfiguration\x18\x02 \x03(\v2*.in_toto_attestation.v1.ResourceDescriptorR\rconfiguration\x12\x10\n" +
	"\x03url\x18\x03 \x01(\tR\x03url\x12!\n" +
	"\fpassed_tests\x18\x04 \x03(\tR\vpassedTests\x12!\n" +
	"\fwarned_tests\x18\x05 \x03(\tR\vwarnedTests\x12!\n" +
	"\ffailed_tests\x18\x06 \x03(\tR\vfailedTestsBu\n" +
...
var (
	...
	file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDescData []byte
)
...
func file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDescGZIP() []byte {
	file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDescOnce.Do(func() {
		file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDesc), len(file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDesc)))
	})
...
func file_in_toto_attestation_predicates_test_result_v0_test_result_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDesc), len(file_in_toto_attestation_predicates_test_result_v0_test_result_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
