...
var file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDesc = string([]byte{
...
var (
	...
	file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDescData []byte
)
...
func file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDescGZIP() []byte {
	file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDescOnce.Do(func() {
		file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDesc), len(file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDesc)))
	})
...
func file_in_toto_attestation_predicates_provenance_v0_provenance_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDesc), len(file_in_toto_attestation_predicates_provenance_v0_provenance_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
