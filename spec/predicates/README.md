...
-   [Computation Receipt]: Attests that a numeric computation (inference, training
    step, reduction) produced a specific output, checkable by re-execution.
...
[Computation Receipt]: computation-receipt.md
